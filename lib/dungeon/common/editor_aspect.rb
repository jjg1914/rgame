      ...
      module SelectionAspect
        ...
        def successor_selection direction = 1
          if selected.size > 1
            ...
            loop do
              ...
              break if e.is_a?(Dungeon::Common::PositionAspect)
            end
          end
        end
        ...
        def single_select x, y
          not @collection.find_index do |e|
            e.is_a?(Dungeon::Common::PositionAspect) and
        ...
        def inflate_select_cursor
          ...
          @collection.each_with_index.select do |e, _|
            e.is_a? Dungeon::Common::PositionAspect
          end.select do |e, _|
      ...
      module FileSaveOpenAspect
        ...
        on :commit do |value|
          ...
          when :open
            ...
            self.parent.map = Dungeon::Core::Map.load_path abs_path
          end
        end
      ...
      class EditorState < Gui::Container
        ...
        on :draw do
          ...
          @collection.each_with_index do |e, i|
            if e.is_a? Dungeon::Common::PositionAspect
