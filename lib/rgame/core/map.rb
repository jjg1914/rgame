    ...
    class Map
      ...
      def self.load_json json
        if json.key?("tiledversion")
          RGame::Core::Map::TiledMap.load_json(json)
        elsif json.dig("meta", "schema") == "rgame"
          RGame::Core::Map::RGameMap.load_json(json)
        else
