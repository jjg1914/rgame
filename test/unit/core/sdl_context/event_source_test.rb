...
describe RGame::Core::SDLContext::EventSource do
  before do
    ...
    @subject = RGame::Core::SDLContext::EventSource.new
  end
  ...
  describe "#each_event" do
    ...
    it "should yield text input event" do
      ...
      expect(@subject.each_event.to_a).must_equal([
        RGame::Core::Events::TextInputEvent.new("_str_", @modifiers),
        RGame::Core::Events::QuitEvent.new,
      ])
    end
  ...
  describe "#text_input_mode=" do
    it "should enable text input" do
      RGame::Core::SDL2.SDL_StopTextInput
      @subject.text_input_mode = true
      expect(RGame::Core::SDL2.SDL_IsTextInputActive).must_equal true
    end

    it "should disable text input" do
      RGame::Core::SDL2.SDL_StartTextInput
      @subject.text_input_mode = false
      expect(RGame::Core::SDL2.SDL_IsTextInputActive).must_equal false
    end
  end
end
